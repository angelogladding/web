...
setup(requires=["acme_tiny", "BeautifulSoup4", "cssselect", "gevent",
      ...
      provides={"pygments.styles": ["Lunar = solarized:Lunar",
                ...
                "web.apps": ["indieauth-client = web.indieauth:client",
                             "indieauth-server = web.indieauth:server",
                             "micropub = web.micropub:server",
                             "webmention = web.webmention:receiver",
                             "websub-publisher = web.websub:publisher",
                             "websub-subscriber = web.websub:subscriber"]},
      discover=__file__)
