...
setup(requires=["acme_tiny", "BeautifulSoup4", "cssselect", "gevent",
      ...
      provides={"pygments.styles": ["Lunar = solarized:Lunar",
                ...
                "web.apps": ["indieauth_client = web.indie.indieauth:client",
                             "indieauth_server = web.indie.indieauth:server",
                             "micropub = web.indie.micropub:server",
                             "webmention = web.indie.webmention:receiver",
                             "websub_pub = web.indie.websub:pub",
                             "websub_sub = web.indie.websub:sub"]},
      discover=__file__)
